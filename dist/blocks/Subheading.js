...
exports.Subheading = function (_a) {
    var children = _a.children, disableAnchor = _a.disableAnchor;
    if (disableAnchor || typeof children !== 'string') {
        return react_1.default.createElement(html_1.H3, null, children);
    }
    var tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, '-');
    return (react_1.default.createElement(mdx_1.HeaderMdx, { as: "h3", id: tagID }, children));
};
